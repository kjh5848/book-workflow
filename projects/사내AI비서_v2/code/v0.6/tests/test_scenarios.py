...
PostgreSQL 연결 상태에서 MCP 도구와 QueryRouter를 검증한다.
실행 방법:
...
class TestStructuredScenarios(unittest.TestCase):
    ...
    def test_scenario_02_sales_sum_dept(self) -> None:
    ...
    def test_scenario_03_list_employees_by_dept(self) -> None:
    ...
    def test_scenario_04_dept_stats(self) -> None:
...
class TestUnstructuredScenarios(unittest.TestCase):
    ...
    def test_scenario_05_onboarding_procedure(self) -> None:
    ...
    def test_scenario_06_security_policy(self) -> None:
    ...
    def test_scenario_07_workcation_info(self) -> None:
    ...
    def test_scenario_08_launch_strategy(self) -> None:
...
class TestHybridScenarios(unittest.TestCase):
    ...
    def test_scenario_10_employee_leave_policy(self) -> None:
...
class TestMcpToolsUnit(unittest.TestCase):
    ...
    def test_list_employees_all(self) -> None:
