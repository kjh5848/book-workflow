...
![](../assets/챕터 7/gemini/07_chapter-opening.png)
...
<div style="font-size:var(--fs-sm);font-weight:700;color:var(--color-accent-text);margin-bottom:var(--space-lg);text-align:center">그림 7-2. 챕터 6 에이전트는 그대로, 바깥에 운영 래퍼 3층을 씌웁니다</div>
...
![](../assets/챕터 7/terminal/07_log-first-query.png)
*그림 7-7. 첫 질문 로그. 입력, 출력 토큰과 소요 시간이 TokenTracker에 기록됩니다*

**두 번째 호출**. ResponseCache HIT.

![](../assets/챕터 7/terminal/07_log-cache-hit.png)
...
![](../assets/챕터 7/terminal/07_stats-dashboard-2.png)
...
*그림 7-10. 챕터 7의 결과. Cache, Monitor, Retry 세 운영 chip이 Runtime 위에 새로 자리를 잡았습니다*
