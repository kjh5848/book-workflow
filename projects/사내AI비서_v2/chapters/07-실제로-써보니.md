...
<div class="sp-figure">
  <div class="sp-figure-title">그림 7-6. ConnectHRAgent 운영 래퍼 구조. 안쪽 코어는 챕터 6 그대로</div>
  <div class="sp-row warm">
    <span class="sp-row-label">바깥층 (이번 챕터)</span>
    <span class="sp-row-value">
      <span class="sp-chip warm">ResponseCache</span>
      <span class="sp-chip warm">TokenTracker</span>
      <span class="sp-chip warm">Retry 루프</span>
    </span>
  </div>
  <div class="sp-flow">
    <div class="sp-step">
      <span class="sp-step-num">바깥 1</span>
      <div class="sp-step-title">ResponseCache</div>
      <div class="sp-step-desc">TTL 메모장. 같은 질문이면 즉시 반환</div>
    </div>
    <div class="sp-flow-arrow">→</div>
    <div class="sp-step">
      <span class="sp-step-num">바깥 2</span>
      <div class="sp-step-title">Retry 루프</div>
      <div class="sp-step-desc">최대 3회, 간격 2초로 재시도</div>
    </div>
    <div class="sp-flow-arrow">→</div>
    <div class="sp-step accent">
      <span class="sp-step-num">코어</span>
      <div class="sp-step-title">IntegratedAgent</div>
      <div class="sp-step-desc">AgentExecutor + MCP Tools + 사후 분류</div>
    </div>
    <div class="sp-flow-arrow">→</div>
    <div class="sp-step">
      <span class="sp-step-num">바깥 3</span>
      <div class="sp-step-title">TokenTracker</div>
      <div class="sp-step-desc">호출별 토큰·비용·지연 기록</div>
    </div>
  </div>
  <div class="sp-callout">호출이 들어오면 캐시 → 재시도 루프 → 코어 → 토큰 기록 순으로 흐릅니다. 코어(<code>IntegratedAgent</code>)는 챕터 6에서 작성한 코드를 그대로 가져다 씁니다.</div>
</div>
