...
문서에는 "재택근무"라고 적혀 있습니다. WFH(Work From Home)를 재택근무로 연결하지 못한 겁니다. CH08에서 해결한 건 **"어떤 문서를 가져오느냐"** 였습니다. 검색 엔진 자체의 성능을 올렸습니다. 그런데 지금 문제는 다릅니다. **검색 엔진이 잘 동작해도, 질문 자체를 이해 못하면 소용없습니다.**
