...
<div class="rag-pipeline-box">
  <div class="rag-pipeline-title">그림 9-4. 사서의 언어 능력 다섯 가지. 검색 전 3개와 검색 후 2개</div>
  <div class="rag-pipeline">
    <div class="rag-step">
      <div class="s-num">1</div>
      <div class="s-title">약어 확장</div>
      <div class="s-desc">사전 기반 치환<br>WFH → 재택근무</div>
      <div class="s-meta">단어 번역</div>
    </div>
    <div class="rag-arrow">→</div>
    <div class="rag-step">
      <div class="s-num">2</div>
      <div class="s-title">HyDE</div>
      <div class="s-desc">가상 답변 생성<br>답변 ↔ 문서 매칭</div>
      <div class="s-meta">답을 먼저 상상</div>
    </div>
    <div class="rag-arrow">→</div>
    <div class="rag-step">
      <div class="s-num">3</div>
      <div class="s-title">Multi-Query</div>
      <div class="s-desc">N개 변형 질문<br>합집합 검색</div>
      <div class="s-meta">여러 갈래로</div>
    </div>
    <div class="rag-arrow">→</div>
    <div class="rag-step">
      <div class="s-num">4</div>
      <div class="s-title">Parent Doc</div>
      <div class="s-desc">자식 청크로 검색<br>부모 문서 반환</div>
      <div class="s-meta">원본 꺼내기</div>
    </div>
    <div class="rag-arrow">→</div>
    <div class="rag-step">
      <div class="s-num">5</div>
      <div class="s-title">Compression</div>
      <div class="s-desc">관련 문장만 추출<br>토큰 절약</div>
      <div class="s-meta">핵심만 남기기</div>
    </div>
  </div>
</div>
