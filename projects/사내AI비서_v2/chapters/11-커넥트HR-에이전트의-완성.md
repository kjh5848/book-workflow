...
<div class="rag-pipeline-title">그림 11-2. RAG 엔진. 질문이 들어와 답변이 나가기까지</div>
<div class="rag-pipeline">
<div class="rag-step">
<div class="s-num">01</div>
<div class="s-title">QueryExpander</div>
<div class="s-desc">사내 약어를 풀어 질문을 보강</div>
<div class="s-meta">expand()</div>
</div>
<div class="rag-arrow">→</div>
<div class="rag-step">
<div class="s-num">02</div>
<div class="s-title">EnsembleRetriever</div>
<div class="s-desc">BM25와 ChromaDB로 자식 청크 검색</div>
<div class="s-meta">search()</div>
</div>
<div class="rag-arrow">→</div>
<div class="rag-step">
<div class="s-num">03</div>
<div class="s-title">CrossEncoderReranker</div>
<div class="s-desc">딥러닝 모델로 정합성 채점</div>
<div class="s-meta">rerank()</div>
</div>
<div class="rag-arrow">→</div>
<div class="rag-step">
<div class="s-num">04</div>
<div class="s-title">ParentDocumentRetriever</div>
<div class="s-desc">자식 청크에서 부모 페이지 복원</div>
<div class="s-meta">resolve()</div>
</div>
</div>
</div>
