...
![docker compose up 실행 — 이미지 빌드 과정](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/terminal/docker-compose-build.png)

빌드가 끝나면 Spring Boot 시작 로그가 나타납니다. `Started` 메시지가 보이면 서버가 정상적으로 올라온 것입니다.

![Spring Boot 서버가 8080 포트에서 시작된 로그](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/terminal/spring-boot-started.png)
...
![localhost:8080 접속 결과 — hello world!. 텍스트가 표시된 브라우저 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/terminal/localhost-8080.png)
...
![Docker Desktop — spring-docker 컨테이너가 실행 중인 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/terminal/docker-desktop-running.png)

자바 설치, 빌드 도구 설정, 포트 설정 — 이 모든 과정이 `docker compose up --build` 한 줄로 끝났습니다. 컨테이너를 내릴 때는 `docker compose down` 을 실행합니다.

![docker compose down 실행 결과 — 컨테이너와 네트워크가 정리된 화면](/Users/nomadlab/Desktop/김주혁/workspace/coding-study/집필에이전트 v2/projects/스프링과_함께하는_레퍼런스_기술모음/assets/CH01/terminal/docker-compose-down.png)
