...
[GEMINI PROMPT: 왼쪽에 고양이 사진 한 장(PNG)이 놓여 있고, 그 옆에 큰 화살표가 엽서 모양 상자로 이어진다. 엽서 상자 안에는 "iVBORw0KGgoAAAANSUhEUgAA..."처럼 Base64 문자열이 여러 줄에 걸쳐 빽빽이 적혀 있다. 엽서 아래에는 작은 손글씨로 "사진을 글자로 받아썼습니다"가 적혀 있다. 깔끔한 일러스트, 흰 배경, 인디고·오렌지 악센트.]
