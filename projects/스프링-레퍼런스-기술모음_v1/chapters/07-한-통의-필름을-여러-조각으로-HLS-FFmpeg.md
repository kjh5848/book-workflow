...
[GEMINI PROMPT: 영화관 영사실 장면. 왼쪽 벽에 "한 통의 필름" 레이블이 붙은 커다란 릴 통 하나가 영사기 한 대에 걸려 있다. 화살표(변환 표시)를 지나 오른쪽에는 "HLS" 레이블 아래 작은 릴 통 여섯~여덟 개가 선반에 가지런히 놓여 있고, 그 앞에 "video.m3u8"이라고 적힌 목록 종이 한 장이 펼쳐져 있다. 종이에는 "video0.ts", "video1.ts", "video2.ts"가 줄지어 적혀 있다. 영사기사(오픈이 캐릭터)가 종이를 들여다보며 1번 릴을 영사기에 거는 모습. 따뜻한 실내등, 흰 바닥, 인디고·오렌지 악센트, 부드러운 일러스트 톤.]
