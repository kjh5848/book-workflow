...
<div class="pipeline-box">
  <div class="pipeline-title">그림 8-3. 챕터 8의 세 실험. 청킹 → 리랭킹 → 하이브리드 검색</div>
  <div class="pipeline">
    <div class="step-card">
      <div class="sc-num">1</div>
      <div class="sc-title">청킹 전략</div>
      <div class="sc-desc">Fixed · Recursive · Semantic<br>세 가지 자르기 비교</div>
      <div class="sc-meta">가위에서 돋보기로</div>
    </div>
    <div class="flow-arrow">→</div>
    <div class="step-card">
      <div class="sc-num">2</div>
      <div class="sc-title">리랭킹</div>
      <div class="sc-desc">Cross-Encoder 로<br>Top-K 재정렬</div>
      <div class="sc-meta">서류 위에 면접관</div>
    </div>
    <div class="flow-arrow">→</div>
    <div class="step-card">
      <div class="sc-num">3</div>
      <div class="sc-title">하이브리드</div>
      <div class="sc-desc">BM25 + Vector<br>alpha 가중합</div>
      <div class="sc-meta">두 사서를 합치기</div>
    </div>
  </div>
</div>
