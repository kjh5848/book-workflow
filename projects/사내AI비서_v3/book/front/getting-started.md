...
| `llama3.1:8b` | CH06~CH11 | Tool Calling 지원 | 16GB 이상 |
| `qwen2.5vl:7b` | CH10·CH11 | 비전 LLM (스캔 PDF 처리) | 16GB 이상 |
...
| `sentence-transformers` | 3.3.x | 한국어 임베딩 + Cross-Encoder Reranker (CH11) |
| `psycopg2-binary` | 2.9.x | PostgreSQL 연결 |
| `pypdf` | 4.3.x | PDF 파싱 |
| `python-docx` | 1.1.x | DOCX 파싱 |
| `openpyxl` | 3.1.x | XLSX 파싱 |
| `rank-bm25` | 0.2.x | 하이브리드 검색 (CH08·CH11) |
