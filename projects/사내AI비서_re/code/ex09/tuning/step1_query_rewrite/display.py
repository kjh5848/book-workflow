...
def show_abbreviation_results(results: list[dict]) -> None:
    """약어/동의어 확장 결과를 출력합니다."""
    console.print(f"\n[bold yellow]실험 1-1. 약어/동의어 확장[/bold yellow]")
...
def show_hyde_results(result: dict) -> None:
    ...
    console.print(f"\n[bold yellow]실험 1-2. HyDE (Hypothetical Document Embeddings)[/bold yellow]")
...
def show_multi_query_results(
    ...
    console.print(f"\n[bold yellow]실험 1-3. Multi-Query[/bold yellow]")
