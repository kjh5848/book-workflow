"""step2 실험 실행기 -- 2-1 ParentDoc / 2-2 SelfQuery / 2-3 Compression."""
...
def run_parent_doc_experiment(
    ...
    """실험 2-1: ParentDocumentRetriever."""
...
def run_compression_experiment(
    ...
    """실험 2-3: ContextualCompressionRetriever."""
    query = query or TEST_QUERIES[0]
    docs = [
        {
            "content": doc["content"],
...
def run_all(query: str | None = None, top_k: int = 2) -> None:
    ...
    console.print("[bold]ex09 step2: 고급 Retriever 실험[/bold]")
