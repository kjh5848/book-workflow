...
def show_parent_doc_results(results: list[dict], query: str) -> None:
    ...
    console.print(f"\n[bold yellow]실험 2-1. ParentDocumentRetriever[/bold yellow]")
...
def show_self_query_results(results: list[dict], query: str) -> None:
    ...
    console.print(f"\n[bold yellow]실험 2-2. SelfQueryRetriever[/bold yellow]")
...
def show_compression_results(results: list[dict], query: str) -> None:
    ...
    console.print(f"\n[bold yellow]실험 2-3. ContextualCompressionRetriever[/bold yellow]")
